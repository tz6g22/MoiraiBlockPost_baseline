...
#SBATCH --job-name=kimi-block-smoke
#SBATCH --output=kimiattnres/outputs/qwen3_1.7b/block_smoke_%j.out
#SBATCH --error=kimiattnres/outputs/qwen3_1.7b/block_smoke_%j.err
...
CONFIG="kimiattnres/configs/qwen3_1.7b_block.yaml"
OUT="$ROOT/kimiattnres/outputs/qwen3_1.7b/block_fsdp_smoke_${SLURM_JOB_ID:-manual}"
